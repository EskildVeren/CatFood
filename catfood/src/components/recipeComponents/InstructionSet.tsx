...
function InstructionSet() {
  return (
    <div className='instructionContainer'>
      ...
      <p>Pizza er en klassiker som nytes av mange. Likevel er det vanlig å strebe etter den perfekte pizzaen. Deilig tynn sprø bunn, bruna ost og smakfull topping
